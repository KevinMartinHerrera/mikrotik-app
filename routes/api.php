...
Route::prefix('v1')->group(function(){
    ...
    Route::get('/add-adress',[RouterosController::class,'add_new_address']);
    ...
    Route::post('/add-user', [RouterosController::class, 'addUser']);
    Route::post('/routeros/set-bandwidth', [RouterosController::class, 'setBandwidth']);
    Route::post('/create_user_group', [RouterosController::class, 'create_user_group']);
