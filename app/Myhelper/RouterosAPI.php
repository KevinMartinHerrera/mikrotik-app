        ...
        if (is_array($response)) {
            ...
            foreach ($response as $x) {
                if (in_array($x, array('!fatal','!re','!trap'))) {
                    if ($x == '!re') {
                        $PARSED[] = [];  // Agrega un nuevo elemento vacío al final del arreglo
                        $CURRENT =& $PARSED[count($PARSED) - 1];  // Crea una referencia al último elemento
                    } else {
                        $PARSED[$x][] = [];  // Añade un nuevo arreglo vacío a $PARSED[$x]
                        $CURRENT =& $PARSED[$x][count($PARSED[$x]) - 1];  // Crea una referencia al último elemento de $PARSED[$x]
